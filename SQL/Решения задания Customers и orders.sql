...
SELECT companyname, orders.customerid, orders.orderdate
FROM customers
JOIN orders
ON orders.customerid = customers.customerid
WHERE orders.orderdate BETWEEN '1996-11-15' AND '1997-02-18'
...
SELECT orderid
FROM orders
WHERE orders.orderdate BETWEEN '1996-12-12' AND '1997-02-12'
...
SELECT companyname, orderid, ordersum 
